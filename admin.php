...
Route::get('massedit', [ProgrammingsController::class, 'massEdit'])->name('admin.programming.massEdit');
Route::put('programming/massupdate', [ProgrammingsController::class, 'massUpdate'])->name('admin.programming.massUpdate');
