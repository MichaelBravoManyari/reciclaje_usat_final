        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Formulario del tipo de usuario</h5>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#datatable').DataTable({
                "ajax": "{{ route('admin.usertypes.index') }}", // La ruta que llama al controlador vía AJAX
                "columns": [{
                        "data": "id",
                    },
                    {
        ...
        $('#btnNuevo').click(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $("#formModal #exampleModalLabel").html("Nuevo Tipo");
        ...
        $(document).on('click', '.btnEditar', function() {
            ...
            $.ajax({
                url: "{{ route('admin.usertypes.edit', 'id') }}".replace('id', id),
                type: "GET",
                success: function(response) {
                    $("#formModal #exampleModalLabel").html("Modificar Tipo");
                    $("#formModal .modal-body").html(response);
                    $("#formModal").modal("show");
